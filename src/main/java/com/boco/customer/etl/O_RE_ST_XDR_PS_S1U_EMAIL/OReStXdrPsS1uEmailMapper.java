...
import com.boco.customer.field.S1uEmail;
...
public class OReStXdrPsS1uEmailMapper extends Mapper<LongWritable, Text, NullWritable, NullWritable> implements S1uEmail {
	...
	protected void map(LongWritable key, Text value, Context context) {
		...
		totalrecord++;
		// 判断字段个数是否满足
		if (xdrdata.length < S1U_EMAIL_LEN) {
			len_err++;//
			return;
		}
		// 手机号码去掉+86开头的
...
//			region_id = arrDimNeEc[6];
		...
		sb.append("").append("|");//SUBAPP_ENDESC
