package com.boco.customer.etl.O_RE_ST_XDR_PS_S1U_FTP;
...
import com.boco.customer.field.S1uFtp;
...
public class OReStXdrPsS1uFtpMapper extends Mapper<LongWritable, Text, NullWritable, NullWritable> implements S1uFtp {
...
//			region_id = arrDimNeEc[6];
		...
		sb.append("").append("|");//subappend_desc
		...
		sb.append(xdrdata[FTP_STATUS]).append("|");
		sb.append(xdrdata[USERNAME]).append("|");
		sb.append(xdrdata[CURRENT_DIR]).append("|");
		sb.append(xdrdata[TRANSFER_MODE]).append("|");
		sb.append(xdrdata[TRANSFER_DIRECTION]).append("|");
		sb.append(xdrdata[FILENAME]).append("|");
		sb.append(xdrdata[FTP_USER_PORT]).append("|");
		sb.append(xdrdata[REMOTE_SERVER_PORT]).append("|");
		sb.append(xdrdata[FILESIZE]).append("|");
		sb.append(xdrdata[RESPONSE_TIME]).append("|");
		sb.append(xdrdata[TRANSFER_TIME]).append("|");
		sb.append(load_time);
		// 组织key
