...
import com.boco.customer.fieldJl.S1uGnrl;
...
public class OReStXdrPsS1uGnrlMapper extends Mapper<LongWritable, Text, NullWritable, NullWritable> implements S1uGnrl {
	...
	protected void map(LongWritable key, Text value, Context context) {
		...
		totalrecord++;
		// 判断字段个数是否满足
		if (xdrdata.length < S1U_GNRL_LEN) {
			len_err++;//
			return;
		}
		// 手机号码去掉+86开头的
