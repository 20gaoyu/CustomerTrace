package com.boco.customer.etl.O_RE_ST_XDR_PS_S1U_MMS;
...
import com.boco.customer.field.S1uMms;
...
public class OReStXdrPsS1uMmsMapper extends Mapper<LongWritable, Text, NullWritable, NullWritable> implements S1uMms {
...
//					region_id = arrDimNeEc[6];
				...
				sb.append(xdrdata[MMS_SEND_ADDR]).append("|");
