...
import com.boco.customer.field.S1uP2p;
...
public class OReStXdrPsS1uP2pMapper extends Mapper<LongWritable, Text, NullWritable, NullWritable> implements S1uP2p {
...
//					region_id = arrDimNeEc[6];
				...
				sb.append(xdrdata[P2P_FLAG]).append("|");
				sb.append(xdrdata[TRACKER]).append("|");
