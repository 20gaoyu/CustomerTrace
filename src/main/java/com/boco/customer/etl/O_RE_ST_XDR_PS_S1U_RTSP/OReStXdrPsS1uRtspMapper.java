package com.boco.customer.etl.O_RE_ST_XDR_PS_S1U_RTSP;
...
import com.boco.customer.field.S1uRtsp;
...
public class OReStXdrPsS1uRtspMapper extends Mapper<LongWritable, Text, NullWritable, NullWritable> implements S1uRtsp {
	...
	protected void map(LongWritable key, Text value, Context context) {
		...
		totalrecord++;
		// 判断字段个数是否满足
		if (xdrdata.length < S1U_RTSP_LEN) {
			len_err++;//
			return;
		}
		// 手机号码去掉+86开头的
