...
import com.boco.customer.field.S1uVoip;
...
public class OReStXdrPsS1uVoipMapper extends Mapper<LongWritable, Text, NullWritable, NullWritable> implements S1uVoip {
	...
	protected void map(LongWritable key, Text value, Context context) {
		...
		totalrecord++;
		// 判断字段个数是否满足
		if (xdrdata.length < S1U_VOIP_LEN) {
			len_err++;//
			return;
		}
		// 手机号码去掉+86开头的
...
//					region_id = arrDimNeEc[6];
				...
				sb.append(xdrdata[PROTOCOL_TYPE_1]).append("|");
