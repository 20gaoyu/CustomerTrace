...
public class S1uFtpZx {
	...
	private int FTP_STATUS=96;
	private int USERNAME=97;
	private int CURRENT_DIR=98;
	private int TRANSFER_MODE=99;
	private int TRANSFER_DIRECTION=100;
	private int FILENAME=101;
	private int FTP_USER_PORT=102;
	private int REMOTE_SERVER_PORT=103;
	private int FILESIZE=104;
	private int RESPONSE_TIME=105;
	private int TRANSFER_TIME=106;
