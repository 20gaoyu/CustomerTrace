...
public class S1uRtspZx {
	...
	private int URL=96;
	private int USERAGENT=97;
	private int RTP_SERVER_IP=98;
	private int CLIENT_SOURCE_PORT=99;
	private int CLIENT_DESTINATION_PORT=100;
	private int SERVER_SOURCE_PORT=101;
	private int SERVER_DESTINATION_PORT=102;
	private int VIDEO_STREAMS=103;
	private int AUDIO_STREAMS=104;
	private int RESPONSE_TIME=105;
	...
	public List<String> ReturnListZx(List<String> list)
	{
		...
		for(String lines:list)
		{
			...
			sb.append(xdrdata[USERAGENT]).append("|");
			sb.append(xdrdata[RTP_SERVER_IP]).append("|");
			sb.append(xdrdata[CLIENT_SOURCE_PORT]).append("|");
			sb.append(xdrdata[CLIENT_DESTINATION_PORT]).append("|");
			sb.append(xdrdata[SERVER_SOURCE_PORT]).append("|");
			sb.append(xdrdata[SERVER_DESTINATION_PORT]).append("|");
			sb.append(xdrdata[VIDEO_STREAMS]).append("|");
			sb.append(xdrdata[AUDIO_STREAMS]).append("|");
			sb.append(xdrdata[RESPONSE_TIME]).append("|");
