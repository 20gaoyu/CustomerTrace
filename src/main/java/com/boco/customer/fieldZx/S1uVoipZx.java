...
public class S1uVoipZx{
	...
	private int CALL_DIRECTION=96;
	private int CALLER=97;
	private int CALLEE=98;
	private int CALL_TYPE=99;
	private int STREAMS_NUM=100;
	private int HANGUP_CAUSE=101;
	private int PROTOCOL_TYPE_1=102;
	...
	public List<String> ReturnListZx(List<String> list)
	{
		...
		for(String lines:list)
		{
			...
			sb.append(xdrdata[LENGTH]).append("|");
			 ...
			 sb.append(xdrdata[CALL_DIRECTION]).append("|");
			 sb.append(xdrdata[CALLER]).append("|");
			 sb.append(xdrdata[CALLEE]).append("|");
			 sb.append(xdrdata[CALL_TYPE]).append("|");
			 sb.append(xdrdata[STREAMS_NUM]).append("|");
			 sb.append(xdrdata[HANGUP_CAUSE]).append("|");
			 sb.append(xdrdata[PROTOCOL_TYPE]).append("|");
