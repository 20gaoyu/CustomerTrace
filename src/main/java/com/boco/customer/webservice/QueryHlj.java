...
@WebService
public class QueryHlj {

	private static String quorum;
	private static String clientPort;
	protected static final Logger log = Logger.getLogger(QueryHlj.class);
	...
	static {
		...
		//对表名做一个映射
		map_table.put(101, "boco:O_RE_ST_XDR_PS_S1U_DNS_DETAIL");
		map_table.put(102, "O_RE_ST_XDR_PS_S1U_MMS_DETAIL");
		map_table.put(103, "boco:O_RE_ST_XDR_PS_S1U_KS_HTTP_DETAIL");
		...
		map_table.put(110, "boco:O_RE_ST_XDR_PS_S1MME_DETAIL");
		map_table.put(111, "O_RE_ST_XDR_PS_S11_DETAIL");
		map_table.put(112, "boco:O_RE_ST_XDR_PS_S1U_HTTP_DETAIL");
...
//			}
	 ...
	 * 
	 * @param tab
	 *            输入参数为boco:O_RE_ST_XDR_PS_S1U_KS_HTTP_DETAIL、
	 *            boco:O_RE_ST_XDR_PS_S1MME_DETAIL
	 * @param msisdns
	 *            手机号码11位
	 * @param startTime
	 *            开始时间
	...
	public List<String> xdrDetailQuery(String tab, String msisdns,
		...
		String tab_kerberos="boco:"+tab;
		List<String> list = xdrDetailQueryList(tab_kerberos, msisdns, startTime,
				endTime, flag);
		// 分页显示
	...
	public static List<String> xdrDetailQueryList(String tab, String msisdns,
		...
		// 查询详单结果
		String tab_kerberos="boco:"+tab;
		List<String> list = getList(tab_kerberos, msisdns, startTime, endTime);
		if (list.size() == 0) {
			return new ArrayList<String>();
		}
		// 通过标识过滤出异常或者全部
		...
		// 按照时间进行排序
		if (tab.equals("boco:O_RE_ST_XDR_PS_S1U_KS_HTTP_DETAIL")) {
			if (flag == 1) {
		...
		} else if (tab.equals("boco:O_RE_ST_XDR_PS_S1MME_DETAIL")) {
			if (flag == 1) {
	...
	public List<String> errCodeList(String tab, String msisdns,
		...
		// 查询详单结果
		String tab_kerberos="boco:"+tab;
		List<String> list = errCodeList(tab_kerberos, msisdns, startTime, endTime,
				codeid);
		// 分页显示
		List<String> result = pageList(list, pageSize, index);
		return result;
	...
	public static void main(String[] args) {
		...
		Endpoint.publish("http://" + args[0] + ":" + args[1] + "/QueryServer/QueryPort", new QueryHlj());
