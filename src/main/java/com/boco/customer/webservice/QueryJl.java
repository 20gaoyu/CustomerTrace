...
@WebService
public class QueryJl {

	private static String quorum;
	private static String clientPort;
	protected static final Logger log = Logger.getLogger(QueryJl.class);
	...
	public static void main(String[] args) {
		...
		Endpoint.publish("http://" + args[0] + ":" + args[1] + "/QueryServer/QueryPort", new QueryJl());
